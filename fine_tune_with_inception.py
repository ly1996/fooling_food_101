...
FC_SIZE = 1024
FINE_TUNE_LAYER = 280
FINE_TUNE_LAYER_2 = 197
FINE_TUNE_LAYER_3 = 101
# RUN = RUN + 1 if 'RUN' in locals() else 1
LOG_DIR = os.path.expanduser('../data')
MODEL_FILE_PATH = os.path.expanduser('../date/checkpoint-inception-{epoch:02d}-{val_loss:.4f}.hdf5')   # 模型Log文件以及.h5模型文件存放地址
